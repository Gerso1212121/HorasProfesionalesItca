import 'package:ai_app_tests/App/Backend/Auth/Admin/Admin_CitasContent.dart';
...
import 'Admin_UsersContent.dart';
import 'Admin_StatisticsContent.dart';
import 'Admin_SettingsContent.dart';
import 'Admin_LogsContent.dart';
import 'Admin_ContentsContent.dart';
...
class _AdminDashboardState extends State<AdminDashboard> {
  ...
  Future<void> _handleLogout() async {
    try {
      ...
      await LogService.log('Admin logout exitoso');
      ...
      await LogService.log('Error en logout admin: $e');
  ...
  Widget _buildMainContent() {
    switch (_selectedIndex) {
      ...
      case 1:
        return const CitasContent(); // Pantalla de Citas
      case 2:
      ...
      case 5:
        return const LogsContent(); // Pantalla de Logs del Sistema
      default:
