...
class DiarioService {
  ...
  // Crear nueva entrada
  Future<DiarioEntry> crearEntrada({
  ...
  Future<List<DiarioEntry>> obtenerEntradas({
    String? categoria,
    String? estadoAnimo,
    ...
    try {
      ...
      return entradasMap.map((map) => DiarioEntry.fromMap(map)).toList();
    } catch (e) {
  ...
  Future<DiarioEntry> actualizarEntrada(DiarioEntry entrada) async {
  ...
  Future<Map<String, List<DiarioEntry>>> obtenerEntradasPorMes(
      DateTime mes) async {
    ...
    final entradasPorDia = <String, List<DiarioEntry>>{};
  ...
  Future<List<DiarioEntry>> buscarEntradas(String query) async {
  ...
  Future<List<DiarioEntry>> obtenerEntradasRecientes() async {
